...
{
Recorro todos los archivos detalle
y utilizo una estructura auxiliar donde acumulo por clave compuesta
(cod_usuario, fecha). Para cada registro, busco si ya existe: si existe sumo el tiempo,
si no existe lo agrego. Al finalizar, obtengo el archivo maestro con los tiempos totales por usuario y fecha.
}
